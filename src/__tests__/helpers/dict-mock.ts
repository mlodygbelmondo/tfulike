...
export const mockDict: Dictionary = {
  ...
  game: {
    ...
    waitingForVotesFrom: "Waiting for votes from:",
    ...
    soloEmpty: "You need synced TikTok likes with playable video URLs to use Solo mode.",
    soloLoading: "Loading solo mode...",
    soloPrevious: "Previous video",
    soloNext: "Next video",
    soloOpenTikTok: "Open on TikTok",
    soloDeleteSession: "Delete session",
    soloDeletingSession: "Deleting...",
    soloHideControls: "Hide controls",
    soloShowControls: "Show controls",
